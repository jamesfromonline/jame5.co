...
const Footer = () => (
    <footer className='footer'>
        <p className='text text--regular text--bold footer__hire-me'>currently <span>available</span> for hire.</p>
        ...
        <Email />
        <p className=' text text--small text--black footer__copyright grit'>&copy;<strong> jame5.co</strong> {new Date().getFullYear()}</p>
